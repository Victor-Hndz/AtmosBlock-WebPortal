    ...
    <div className="space-y-6">
      ...
      <FormField id="fileFormat" label="File Format" tooltip="Select the output file format for your data">
        <Select.Root value={formData.fileFormat ?? ""} onValueChange={value => updateFormField("fileFormat", value)}>
          <Select.Trigger
            className="inline-flex items-center justify-between w-full px-3 py-2 text-sm border border-gray-300 rounded-md shadow-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              ...
              <Select.Viewport className="p-1">
                {fileFormatOptions.map(format => (
                  <Select.Item
                    key={format}
                    value={format}
                    className="relative flex items-center h-8 px-6 text-sm rounded-md select-none hover:bg-blue-100 data-[highlighted]:outline-none data-[highlighted]:bg-blue-100"
                  >
      ...
      {advancedMode && (
        <>
          ...
          <div className="border-t border-gray-200 pt-4">
            <h3 className="text-lg font-medium mb-3">Parallel Processing Options</h3>
