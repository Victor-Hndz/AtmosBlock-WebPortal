...
int main(int argc, char **argv) {
    int ncid, retval, i, j, k, time, lat, lon, size_x, size_y, step, bearing_count, bearing_count2, id, rank, size, time_start, time_end, resto, base_chunk;
